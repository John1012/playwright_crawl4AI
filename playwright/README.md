...
### **[專案一：PTT 熱門文章爬蟲](專案一_PTT熱門文章爬蟲/README.md)**
- 爬取 PTT 熱門看板文章
- 擷取文章標題、作者、日期等資訊
- 資料儲存與處理

### **[專案二：維基百科搜尋器](專案二_維基百科搜尋器/README.md)**
- 自動搜尋維基百科關鍵字
- 擷取搜尋結果與文章內容
- 多語言支援

### **[專案三：台灣高鐵時刻表查詢](專案三_台灣高鐵時刻表查詢/README.md)**
- 自動查詢高鐵時刻表
- Cookie 管理與保存
- 動態時間計算（現在時間 + 1 小時）
- 表單自動填寫與資料擷取
