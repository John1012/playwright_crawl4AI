...
3. **再學 Crawl4AI 進階** → [開始 Crawl4AI 學習](./crawl4AI/README.md)
...
### 1. 台灣銀行牌告匯率
- **檔案**: [main.py](./crawl4AI/實際案例/1台灣銀行牌告匯率/main.py)
- **類型**: 靜態網頁的範例
- **適合**: 剛入門的時候看

### 2. 台灣即時股票資訊
- **檔案**: [main.py](./crawl4AI/實際案例/2台灣即時股票資訊/main.py)
- **類型**: 動態網頁的範例，要處理 JavaScript 渲染的內容
- **適合**: 有基礎之後挑戰

### 3. Tkinter GUI 整合
- **資料夾**: [4台灣即時股票資訊_tkinter](./crawl4AI/實際案例/4台灣即時股票資訊_tkinter/)
- **類型**: 完整的桌面應用程式，加上自動更新功能
- **適合**: 看實際應用的樣子
